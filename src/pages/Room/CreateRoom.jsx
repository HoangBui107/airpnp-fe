...
import { createRoom, getRoomById } from "../../redux/room/roomThunks";
...
const CreateRoom = () => {
    ...
    const { loading, details } = useSelector((state) => state.room)
    console.log(details)
    ...
    useEffect(() => {
        const flectData = async () => {
            await dispatch(getRoomById({ id: id })).unwrap().then((res) => {
                console.log(res, "as")
        ...
        // setInitialValues({ name: '123321' })
        if (currentPath[1] === 'editRoom' && id) {
            flectData()
        }
    }, [id])
                                    ...
                                    <div className="flex w-[90%] mx-auto">
                                        <div class="w-[50%] grid gap-4 sm:grid-cols-2 sm:gap-6 px-6">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <Field onChange={(e)=>{setFieldValue('price', parseInt(e.target.value ))}} type="number" name="price" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="$2999" required="" />
                                            </div>
                                            <div>
