        ...
        <>
            <div className="px-10 py-5">
                <div>
                    ...
                    <h1 className="font-semibold text-xl">Astro House/ SANTORINI Studio w Pool </h1>
                    ...
                    <div className="flex py-5">
                        <div className="flex w-2/3 flex-col">
                            ...
                            <div className="py-5">
                                ...
                                <h6 className="pb-2">There is a place filled with sunshine & sea breeze near My Khe beach called Astro House, where you can catch the vibe of Santorini in Danang. Nested on 3rd floor, city views appear through the big windows.</h6>
                            ...
                            <div className="flex py-4">
                                ...
                                <div className="flex w-2/4 flex-col ml-40">
                                    <ul>
                        ...
                        <div className="flex w-1/3  justify-end ">
                            <div className="flex flex-col bg-fixed border border-black py-4 px-4 rounded-lg shadow-2xl max-h-[40vh] sticky top-44 ">
                                <div className="flex flex-row items-center">
                                ...
                                <div className="flex py-2 justify-between">
                                    ...
                                    <h1 className="font-blod text-xl">$360</h1>
                                </div>
                            </div>
