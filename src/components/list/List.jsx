...
import DetailsChartModal from "../modals/DetailsChartModal";
        ...
        <div className="flex-3 flex flex-col justify-between  gap-4 px-4 lg:px-0">
          ...
          <div className="flex justify-around pb-4 px-10">  
            <div className="flex flex-col md:flex-row  gap-5">
              ...
              <button className="py-2 px-4 bg-[#b3ca31] hover:bg-[#fdef6f] text-white rounded-md" onClick={()=>{handleEdit(item?.id)}}>Edit</button>
